...
echo ""
echo "Done. The PDF report format is now available (via Typst — no LaTeX required):"
echo ""
...
echo ""
echo "For the 16:9 slide deck, install the probity-slides extension separately"
echo "(format: probity-slides-typst)."
echo ""
